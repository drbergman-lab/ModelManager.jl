...
function processSimulationTask(simulation_task; kwargs...)
    ...
    @info "Simulation $(simulation_process.simulation.id) completed with success=$(simulation_process.success)."
    postSimulationProcessing(mm_globals().simulator, simulation_process; kwargs...)
    @info "Post-processing for simulation $(simulation_process.simulation.id) completed."
